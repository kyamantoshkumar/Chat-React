...
return (
	...
	<div>
		<h1 style={{background:'#7371f7'}} className='fs-3 fw-bold text-center py-2 rounded text-light my-3'>User Registration</h1>
	</div>
	...
	<form className='form-control' style={{background:'#91b9f5'}}>
